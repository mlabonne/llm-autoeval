...
pip install -q requests accelerate sentencepiece pytablewriter einops protobuf deepspeed gekko bitsandbytes
...
case "$BENCHMARK" in
  "nous")
    ...
    run_benchmark_nous "truthfulqa" "truthfulqa_mc1"
